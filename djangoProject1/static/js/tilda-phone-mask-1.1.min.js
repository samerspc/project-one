...
function t_form_phonemask_load_one(e) {
    e = document.querySelectorAll("#rec" + e + " .js-phonemask-input");
    Array.prototype.forEach.call(e, t_form_phonemask_load)
}
        ...
        if (!(p = p || (window.tildamode && "zero" === window.tildamode ? (p = a.querySelector('.tn-artboard [data-input-lid="' + t + '"]')) || a.querySelector(".tn-artboard") : (p = document.querySelector('[data-input-lid="' + t + '"]')) || document.body)).getAttribute("data-init-mask")) {
            ...
            if (o) {
                ...
                var s = p.querySelector(".t-input-phonemask__select-flag"),
                    m = p.querySelector(".t-input-phonemask__select-code"), e = o.getAttribute("data-phonemask-mask"),
...
function t_form_phonemask__addCurrentStyle(e) {
    var t = e.querySelector(".t-input-phonemask__wrap"), n = e.querySelector(".t-input-phonemask"),
        a = e.querySelector(".t-input-block"), p = e.querySelector(".t-input-phonemask__select-code"),
        o = t.style.color, i = t.style.fontSize, e = t.style.fontWeight, t = t.style.fontFamily;
...
function t_form_phonemask__initSelectEvents(a, p, i) {
    var o = a.querySelectorAll(".t-cover, .t396__artboard"), n = p.querySelector(".t-input-phonemask"),
        e = p.querySelector(".t-input-phonemask__select"), r = p.querySelector(".t-input-phonemask__options-wrap"),
        t = p.querySelectorAll(".t-input-phonemask__options-item"), s = "", m = "";
    ...
    function d(e) {
        ...
        if (t) {
            var n = /[-[\]/{}()*+?.\\^$|]/g, a = t.querySelector(".t-input-phonemask__options-item_chosen"), p = [];
...
function t_form_phonemask__copypasteHandling(e, t) {
    var n = e.value, a = n.match(/[0-9]/g) ? n.match(/[0-9]/g) : n;
...
function t_form_phonemask__addNumberMask(e, t) {
    var n = t.getAttribute("data-phonemask-code"), n = t.getAttribute("data-phonemask-mask").substr(n.length),
        e = e.match(/\d+/g), a = (e = e ? e.join("") : "").split(""), p = n.match(/(\+|\d+|[\s()-]|9+)/g), o = "";
    if (p) {
...
function t_form_phonemask__chooseCountry(e, t) {
    var n = e.querySelector(".t-input-phonemask"), a = e.querySelector(".t-input-phonemask__select-code"),
        p = e.querySelector(".t-input-phonemask__select-flag"), o = t.getAttribute("data-phonemask-code"),
        i = t.getAttribute("data-phonemask-mask"), r = t.getAttribute("data-phonemask-country-code"),
...
function t_form_phonemask__searchCountry(e, t, n, a, p) {
    t = new RegExp(t, "i");
    -1 !== p.search(t) && (n.push(e.querySelector("#t-phonemask_" + a)), n[0].classList.add("t-input-phonemask__options-item_chosen"))
}
...
Array.prototype.some || (Array.prototype.some = function (e) {
    ...
    for (var t = Object(this), n = t.length >>> 0, a = 2 <= arguments.length ? arguments[1] : void 0, p = 0; p < n; p++) if (p in t && e.call(a, t[p], p, t)) return !0;
    return !1
}), function (e) {
    ...
    e.matches = e.matchesSelector = t || function (e) {
        var t = document.querySelectorAll(e), n = this;
