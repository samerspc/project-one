window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    ...
    t_forms__initForms();
    var a = !!document.querySelector(".t706"), n = !!document.querySelector(".js-payment-systembox"),
        s = !!document.querySelector("input[name=tld_product]");
    if (a || n || s) {
        var l = "tilda-forms-payments-1.0", c;
            ...
            if (d && (E || A && x)) w.type.push("req"); else {
                switch (u) {
                    ...
                    case"url":
                        ...
                        break;
                    case"phone":
                        var F = s.getAttribute("data-tilda-mask"), S = "^[0-9()+-";
    ...
    if ("y" === b) {
        var T = void 0 !== window.tcart_minorder && window.tcart_minorder > 0,
            C = void 0 !== window.tcart_mincntorder && window.tcart_mincntorder > 0, w, w;
        if (T) if (window.tcart.prodamount < window.tcart_minorder) (w = {
            obj: {},
            type: []
    ...
    if ("object" != typeof t || t.length) {
        t instanceof Element || (t = t[0]);
        var r = t.querySelectorAll(".js-errorbox-all"), o = t.querySelectorAll(".js-rule-error"),
            a = t.querySelectorAll(".js-error-rule-all"), n = t.querySelectorAll(".js-successbox"),
    ...
    var o = t.getAttribute("id"), a = t.getAttribute("data-inputbox");
    a || (a = ".blockinput");
    var n = "", s = !1, l = !0, c = "", d = "", u = "", m = "", p = document.getElementById("tilda-popup-for-error");
    ...
    for (var f = 0; f < r.length; f++) if (r[f] && r[f].obj) {
        if (0 === f && "none" === r[f].obj) {
        ...
        for (var w = 0; w < r[f].type.length; w++) {
            var y = r[f].type[w], h = t_forms__getMsg(y);
        ...
        if (Array.prototype.forEach.call(g, (function (t) {
            ...
            if (v && v.length) {
                var b, E = '.t1093 .t-popup[data-tooltip-hook="' + v[v.length - 1] + '"]',
                    A = document.querySelector(E), x = A ? getComputedStyle(A).zIndex : 0, F;
    ...
    o || (o = ".blockinput");
    for (var a = "", n = !1, s = !0, l = "", c = "", d = "", u = [], m = 0; m < r.length; m++) if (r[m] && r[m].obj) {
        if (0 === m && "none" === r[m].obj) {
            ...
            for (var p = 0; p < l.length; p++) {
                ...
                var f = t.querySelectorAll(".t-input")[0], _;
        ...
        for (var p = 0; p < r[m].type.length; p++) {
            var y = r[m].type[p], h = r[m].obj.id;
            if (d = "", (l = t.querySelectorAll(".js-rule-error-" + y)).length) for (var g = 0; g < l.length; g++) {
                var v;
            ...
            } else if (t_forms__getMsg(y) && (l = t.querySelectorAll(".js-rule-error-all")).length) for (var g = 0; g < l.length; g++) {
                var v;
    ...
    t instanceof Element || (t = t[0]);
    var o = document.getElementById("tildaformcaptchabox"), a = document.getElementById("js-tildaspec-captcha"), n;
    ...
    var r = "", o = document.getElementById("tildaformsuccesspopup"),
        a = document.getElementById("tildaformsuccesspopuptext"), n = document.body;
    if (!o) {
    ...
    if ("y" === form.getAttribute("data-is-formajax")) {
        ...
        return xhr.open("POST", form.getAttribute("action"), !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function () {
            if (4 === xhr.readyState) if (xhr.status >= 200 && xhr.status < 400) {
                var t = form.querySelector(".js-successbox"), r = form.getAttribute("data-success-url"),
                    o = form.getAttribute("data-success-callback"), a;
                if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", a = xhr.responseText) if ("{" == a.substring(0, 1)) {
                    var n = JSON.parse(a);
                    if ("object" == typeof n) if (n && n.message && "OK" !== n.message) t.innerHTML = n.message; else if (n && n.error) {
                        var s,
                            l = (s = t_forms__getErrorContainers(form, "Unknown error. Please, try again later.")).errorBoxes,
                            c = s.allError;
                ...
                var d = "/tilda/" + formId + "/submitted/", u = "Send data from form " + formId;
                ...
                t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0";
                var s, l = (s = t_forms__getErrorContainers(form, "")).errorBoxes, c = s.allError, a = xhr.responseText;
...
function t_forms__removePlaceholder(t) {
    ...
    if ("INPUT" === r.tagName) {
        var o = r.closest("[data-input-lid]"), a = r.getAttribute("placeholder"), n = "";
...
function t_forms__addPlaceholder(t) {
    var r = (t = t || window.event).target || t.srcElement, o = r.closest("[data-input-lid]"), a = "";
...
function t_forms__addInputItsGood(t) {
    ...
    Array.prototype.forEach.call(r, (function (t) {
        var r = t.getAttribute("data-formactiontype"), o = t.querySelector('input[name="form-spec-comments"]');
    ...
    if (t || !document.body.classList.contains("t706__body_cartwinshowed") && !document.body.classList.contains("t706__body_cartpageshowed") || (r = document.querySelector(".t706")), r) {
        ...
        if (o) {
            ...
            if (o.classList.contains("t-form__inputsbox_inrow") || (a = r.querySelectorAll(".t-input-block_width")), 0 !== a.length) {
                ...
                var n = o.offsetWidth, s = ["rd", "ri", "uc", "ws", "hd", "fr", "st"];
                Array.prototype.forEach.call(a, (function (t) {
                    if (o.classList.contains("t-form__inputsbox_inrow") || (t = t.closest(".t-input-group")), t && t.classList.contains("t-input-group_inrow-withsibling")) {
                        var r = t.nextElementSibling, a = s.filter((function (t) {
...
function t_forms__combineFieldsWithDefWidth(t, r) {
    ...
    t_forms__createArrWithAllRows(t, "t-input-group_widthdef").forEach((function (t) {
        var r = 4;
        if (t.length > 4) for (var a = 0; a < t.length; a += 4) {
            var n = t.slice(a, a + 4);
            o.push(n)
        } else o.push(t)
    })), o.forEach((function (t) {
        var o, a = "t-input-group_width" + ({4: "25", 3: "33", 2: "50"}[t.length] || "100");
...
function t_forms__calculateFieldsWidthInJS(t, r) {
    ...
    for (var n in a) if (t.classList.contains(a[n])) {
...
function t_forms__initBtnClick(t) {
    var r = (t = t || window.event).target || t.srcElement, o = !!r.closest('[type="submit"]') && r;
    if (o) {
        var a = o.closest(".js-form-proccess");
        if (a) {
            t.preventDefault ? t.preventDefault() : t.returnValue = !1;
            var n = a.getAttribute("id"), s = [], l = "";
            if (o.tildaSendingStatus && (l = o.tildaSendingStatus), !(l && l >= 1 || t_hasClass(o, "t706__submit_disable"))) {
                ...
                var c, d = document.getElementById("allrecords").getAttribute("data-tilda-formskey"),
                    u = parseInt(a.getAttribute("data-formactiontype")), m;
                if (!a.querySelectorAll(".js-formaction-services").length && 1 !== u && !d) {
                    var p = t_forms__getErrorContainers(a, ""), f = p.errorBoxes, _ = p.allError;
                ...
                if (a.querySelector(".g-recaptcha") && grecaptcha) {
                    window.tildaForm.currentFormProccessing = {form: a, btn: o, formtype: u, formskey: d};
                    var w = a.tildaCaptchaClientId;
                    if (w) grecaptcha.reset(w); else {
                        var y = {
                            size: "invisible",
...
function t_forms__submitEvent(t) {
    ...
    if (t.target && (r = t.target), r) {
        var o = r.querySelector('[type="submit"]'), a = "";
...
function t_asyncLoad(t) {
    var r = t.getAttribute("data-tilda-mask"), o = t.getAttribute("data-tilda-mask-holder"),
...
function t_forms__getErrorContainers(t, r) {
    var o = t.querySelectorAll(".js-errorbox-all"), a = t.querySelectorAll(".js-errorbox-all .js-rule-error-all");
    ...
    })), a = t.querySelectorAll(".js-errorbox-all .js-rule-error-all")), {errorBoxes: o, allError: a}
}
    ...
    Array.prototype.forEach.call(t, (function (t) {
        ...
        if (r) {
            ...
            if (!window.tildaForm.isRecaptchaScriptInit) {
                var a = document.head, n = document.createElement("script");
...
function t_parseScripts(t, r) {
    ...
    Array.prototype.forEach.call(o, (function (r) {
        ...
        if (r.innerHTML.length) o.appendChild(document.createTextNode(r.innerHTML)), r.parentNode.replaceChild(o, r); else {
...
function t_forms__onSuccess(t) {
    t instanceof Element || (t = t[0]);
    var r = t.closest(".r"), o = r.getAttribute("data-record-type"), a = t.querySelector(".t-form__inputsbox"),
        n = getComputedStyle(a, null), s = parseInt(n.paddingTop) || 0, l = parseInt(n.paddingBottom) || 0, c, d,
        u = a.clientHeight - (s + l) + (a.getBoundingClientRect().top + window.pageYOffset), m,
        p = t.querySelector(".t-form__successbox").getBoundingClientRect().top + window.pageYOffset, f = 0,
        _ = window.innerHeight, w = document.body, y = document.documentElement,
    ...
    var v = "t" + o + "__inputsbox_hidden", b = [702, 708, 862, 945, 1014, 1114], E = !0;
    ...
    if (p > window.scrollY || h - u < _ - 100) a.classList.add(v), _ > h && A && setTimeout((function () {
        ...
        for (var x = 0; x < b.length; x++) if (b[x] == o) {
            E = !1;
            break
        }
    ...
    if (F && setTimeout((function () {
        ...
        var S = r.querySelector(".t" + o + "__btn_prev"), k = r.querySelector(".t" + o + "__wrapper"),
...
Array.prototype.some || (Array.prototype.some = function (t) {
    ...
    for (var r = Object(this), o = r.length >>> 0, a = arguments.length >= 2 ? arguments[1] : void 0, n = 0; n < o; n++) if (n in r && t.call(a, r[n], n, r)) return !0;
    return !1
}), function (t) {
    ...
    t.matches = t.matchesSelector = r || function matches(t) {
        var matches = document.querySelectorAll(t), r = this;
    ...
    var s = 0 | r;
    if (s >= n) return -1;
    for (o = Math.max(s >= 0 ? s : n - Math.abs(s), 0); o < n; o++) if (o in a && a[o] === t) return o;
    return -1
});
...
function t_serializeArray(t) {
    for (var r = [], o = t.querySelectorAll("input, textarea, button, select"), a = 0; a < o.length; a++) {
        ...
        if (!(!o[a].name || o[a].disabled || ["file", "reset", "submit", "button"].indexOf(o[a].type) > -1 || n && n.getAttribute("data-hidden-by-condition"))) if ("select-multiple" !== o[a].type) ["checkbox", "radio"].indexOf(o[a].type) > -1 && !o[a].checked || r.push({
            name: o[a].name,
            value: o[a].value
        }); else for (var s = o[a].options, l = 0; l < s.length; l++) s[l].selected && r.push({
            name: s[l].name,
            value: s[l].value
        })
    }
...
function t_fadeOut(t) {
    if ("none" !== t.style.display) var r = 1, o = setInterval((function () {
