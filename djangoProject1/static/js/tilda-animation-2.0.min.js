...
function t_animate__getMediaQuery(t, e) {
    var a = "", n = !1, i = t[e + 1], r = t[e] - 1, o = e === t.length - 1, e = e === t.length - 2;
...
function t_animate__animateNumbers(e) {
    if (!e) return !1;
    var a, n, i, r, o, s, l = e.getAttribute("data-animate-number-count"), m = [], t = e.querySelectorAll("span"),
        c = ((t = Array.prototype.filter.call(t, function (t) {
            return !t.classList.contains(".t-animate__number")
        })).length && (m = t[0].getAttribute("style") || ""), []), _ = null,
...
function t_animate__getAttrByResBase(t, e) {
    ...
    var i, r, n = "ab" + n.getAttribute("data-artboard-recid"),
        ...
        n = t.closest(".t396__elem, .t396__group"), n = n && n.getAttribute("data-animate-mobile");
