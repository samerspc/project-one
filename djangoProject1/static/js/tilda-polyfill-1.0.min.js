Array.prototype.forEach || (Array.prototype.forEach = function (e, t) {
    ...
    Object.defineProperty = function defineProperty(o, i, c) {
        ...
        var a = String(i), l = "value" in c || "writable" in c, p = "get" in c && typeof c.get,
            u = "set" in c && typeof c.set;
        if (p) {
            if (void 0 === p) return o;
            if ("function" !== p) throw new TypeError("Getter must be a function");
            if (!t) throw new TypeError(r);
            if (l) throw new TypeError(n);
    ...
    return function (t) {
        ...
        Temp.prototype = t;
        var r = new Temp;
        if (Temp.prototype = null, arguments.length > 1) {
            var n = Object(arguments[1]);
            for (var o in n) e.call(n, o) && (r[o] = n[o])
        }
        return r
    }
}()), !window.addEventListener && function (e, t, r, n, o, i, c) {
    e[n] = t[n] = r[n] = function (e, t) {
        var r = this;
    ...
    ClassList.prototype = {
        add: function () {
            ...
            forEach(arguments, (function (e) {
                this.element.className = this.element.className.replace(regExp(e), "")
            }), this)
        }, toggle: function (e) {
            return this.contains(e) ? (this.remove(e), !1) : (this.add(e), !0)
        }, contains: function (e) {
            return regExp(e).test(this.element.className)
    ...
    }), window.DOMTokenList && null == DOMTokenList.prototype.replace && (DOMTokenList.prototype.replace = ClassList.prototype.replace)
    ...
    return null
}), window.document.querySelectorAll || (document.querySelectorAll = document.body.querySelectorAll = Object.querySelectorAll = function querySelectorAllPolyfill(e, t, r, n, o) {
    var i = document, c = i.createStyleSheet();
    for (o = i.all, t = [], r = (e = e.replace(/\[for\b/gi, "[htmlFor").split(",")).length; r--;) {
        for (c.addRule(e[r], "k:v"), n = o.length; n--;) o[n].currentStyle.k && t.push(o[n]);
        c.removeRule(0)
    }
    return t
}), !window.getComputedStyle && document.documentMode <= 8 && (window.getComputedStyle = function getComputedStylePolyfill(e) {
...
}(), window.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach), Array.from || (Array.from = function () {
    var e = Object.prototype.toString, isCallable = function (t) {
        return "function" == typeof t || "[object Function]" === e.call(t)
    }, toInteger = function (e) {
        var t = Number(e);
        return isNaN(t) ? 0 : 0 !== t && isFinite(t) ? (t > 0 ? 1 : -1) * Math.floor(Math.abs(t)) : t
    }, t = Math.pow(2, 53) - 1, toLength = function (e) {
        var r = toInteger(e);
        return Math.min(Math.max(r, 0), t)
    };
    return function from(e) {
        var t = this, r = Object(e);
        if (null == e) throw new TypeError("Array.from requires an array-like object - not null or undefined");
        var n = arguments.length > 1 ? arguments[1] : void 0, o;
        if (void 0 !== n) {
            if (!isCallable(n)) throw new TypeError("Array.from: when provided, the second argument must be a function");
            arguments.length > 2 && (o = arguments[2])
        }
        for (var i = toLength(r.length), c = isCallable(t) ? Object(new t(i)) : new Array(i), a = 0, l; a < i;) l = r[a], c[a] = n ? void 0 === o ? n(l, a) : n.call(o, l, a) : l, a += 1;
        return c.length = i, c
    }
}());
